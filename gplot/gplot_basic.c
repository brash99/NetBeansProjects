...
void gplot_basic(double x[], double y[], int Npoints, char title[], char xlabel[], char ylabel[], char legendlabel[], char system_type[]) {
...
void gplot_basicline(double x[], double y[], int Npoints, char title[], char xlabel[], char ylabel[], char legendlabel[], char system_type[]) {
