...
void gplot_errors(double x[], double y[], double e[], int Npoints, char title[], char xlabel[], char ylabel[], char legendlabel[], char system_type[]) {
    ...
    strcat(this_legendlabel,"' with points linestyle 1 with errors\n");
